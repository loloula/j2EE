  ...
  <div id="tooplate_main">
        ...
        <h2>Bienvenue ${pageContext.request.userPrincipal.name} | <a onclick="document.forms['logoutForm'].submit()">Logout</a></h2>
            ...
            <div class="content">
            	 ...
            	 <h1>Calcul distance entre deux monument</h1>
            	 <div class="col_w340 float_l">
            	 <c:url var="saveUrl" value="/calcul" />
		        <form:form method="POST"  action="${saveUrl}" class="form-signin">
		            ...
		            <select id="titleInput" name="monument1">
					    ...
					    <c:forEach items="${monuments}" var="monument">
					            ...
					            <option value="${monument.codeM}" selected>${monument.nomM}</option>
					       
					        
					    </c:forEach>
					</select>
					<select id="titleInput" name="monument2">
		            ...
		            <button class="btn btn-lg btn-primary btn-block" type="submit">calculer</button>
		        </form:form>
		        </div>
			...
			<div class="content">
			<h1>Monuments Historiques les plus représentés</h1>
...
<c:forEach var="station" items="${monuments}">
<tr >
<td >${station.codeM}</td>
<td>${station.nomM}</td>
<td>${station.proprietaire}</td>
<td>${station.typeM}</td>
<td>${station.longitude}</td>
<td >${station.latitude}</td>
<td >${station.codelieu}</td>
</tr>
 </c:forEach>
    	...
    	<div class="content_box">
            ...
            <div class="content">
            	<div class="image_wrapper image_fr"><img src="images/tooplate_image_02.jpg" alt="Image 02" /><span></span></div>
